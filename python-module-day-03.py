...
print(f"{my_info}")
print()
print(f'My name is {my_info["name"]}. I am {my_info["age"]} years old and I wake up at {my_info["Wake-up Times"]["Saturday"]} on Saturdays')
...
#MY this method runs faster, but isn't as readable
...
print(average2([1, 5, 9]))
print(average2(range(11)))
...
def print_percentages(state_data):
   ...
   # print(public_students)
    ...
    print(f"Public School Graduation Rate:  {public_grad_rate}")
    print(f"Private Non-Profit Graduation Rate: {nonprofit_grad_rate}")
    print(f"Private For-Profit Graduation Rate: {forprofit_grad_rate}")   
    print(f"Overall Graduation Rate: {overall_grad_rate}")
    print(f"{message}")
